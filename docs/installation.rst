...
| (and subclasses)                      |                                                                                                     | MICROSOFT\_SUBSCRIPTION\_LOCATION    | registered region              | westus                                |
+---------------------------------------+-----------------------------------------------------------------------------------------------------+--------------------------------------+--------------------------------+---------------------------------------+
| ClarifaiAPIExtractor                  | `Clarifai image recognition API <https://clarifai.com>`__                                           | CLARIFAI\_ACCESS_TOKEN               | Personal access token          | 168ed02e137459ead66c3a661be7b784      |
| (and subclasses)                      |                                                                                                     | CLARIFAI\_USER\_ID                   | User name                      | user_name                             |
|                                       |                                                                                                     | CLARIFAI\_APPLICATION\_ID            | Application name               | my_application                        |
+---------------------------------------+-----------------------------------------------------------------------------------------------------+--------------------------------------+--------------------------------+---------------------------------------+
